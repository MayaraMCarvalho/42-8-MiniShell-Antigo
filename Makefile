...
#    Updated: 2023/09/08 18:29:21 by macarval         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES			= args.c cd.c commands.c echo.c env.c export.c \
				flags.c free.c handling.c local.c minishell.c \
				node.c split_mod.c tokenization.c unset.c utils.c
