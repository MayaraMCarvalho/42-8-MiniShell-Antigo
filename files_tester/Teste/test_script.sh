...
run_test "cat < out.txt" "bash: out.txt: Permission denied "
...
run_test "ls > out.txt" "bash: out.txt: Permission denied "
run_test "ls > Teste/" "bash: Teste/: Is a directory "
...
run_test "ls | grep " "" ""
run_test "cat < Teste/abc.txt" ""
run_test "ls > Teste/abc.txt" ""
